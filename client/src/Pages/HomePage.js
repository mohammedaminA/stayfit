    ...
    <div>
      <div className="header">
        <div className="text-center">
          ...
          <h4 className="text-white">Schedule Your Workouts</h4>
        </div>
      </div>
      ...
      {loginState ? (
        ...
        <div className="d-flex aling-items-center justify-content-center mx-5">
          <div style={{ width: "50vw" }}>
            <img
              src={
                "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/fitness-hangover-1565770628.jpg?crop=0.668xw:1.00xh;0.252xw,0&resize=980:*"
              }
          ...
          <div style={{ width: "50vw" }}>
            <h1 className="m-0">
              Schedule Your <span style={{ color: "red" }}>Fitness</span> With
              Us
            </h1>
            <ol>
